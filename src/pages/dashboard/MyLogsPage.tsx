...
const MyLogsPage: React.FC = () => {
  ...
  const getMyLogs = async (): Promise<void> => {
    try {
      setLoading(true);
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <Spinner size="lg" text="Loading your activity logs..." />
      </div>
    );
  }
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="p-3 bg-green-100 rounded-xl">
                <AiOutlineFileText className="h-8 w-8 text-green-600" />
              </div>
              <div>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500"
              />
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          {filteredLogs.length === 0 ? (
            <div className="p-12 text-center">
              <AiOutlineFileText className="h-16 w-16 text-gray-300 mx-auto mb-4" />
